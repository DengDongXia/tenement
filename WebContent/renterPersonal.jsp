	...
	<div class="maincontent">
		...
		<div class="content">
			<div class="userInfo">
				...
				<p class="owner">房东</p>
				<p><span class="label">昵称：</span><span>LuLuLa</span></p>
				<p><span class="label">邮箱：</span><span>1111@qq.com</span></p>
				<p><span class="label">手机号码：</span><span>13661192011</span></p>
			...
			<div class="orderInfos">
				...
				<div class="allOrder">
					<!-- <span>暂时没有订单</span> -->
					<p class="chooseOrder"><span id="published" class="choose">已发布的客房信息</span><span id="indeterminate">待确认订单</span><span id="allorders">所有订单</span></p>
					<!-- 房东已发布的所有信息 -->
					<ul id="publishedInfo">
						<li>
							...
							<div class="aboutText">
								...
								<div class="otherInfo">
									...
									<p><span class="delete" id="delete">删除</span><span class="edit" id="edit">编辑</span></p>
								</div>
							</div>
